...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color alternate = const Color(0xFFD8F3DC);
  late Color primaryText = const Color(0xFF081C15);
  late Color secondaryText = const Color(0xFF40916C);
  late Color primaryBackground = const Color(0xFFF8FAF9);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0x4C4B39EF);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0xFF95D5B2);
  late Color accent4 = const Color(0xCCFFFFFF);
  late Color success = const Color(0xFF2D6A4F);
  late Color warning = const Color(0xFFE9C46A);
  late Color error = const Color(0xFFE76F51);
  late Color info = const Color(0xFF457B9D);

  late Color onPrimary = const Color(0xFFFFFFFF);
  late Color primaryContainer = const Color(0x1A2D6A4F);
  late Color onPrimaryContainer = const Color(0xFF081C15);
  late Color onSecondary = const Color(0xFFFFFFFF);
  late Color secondaryContainer = const Color(0x1A52B788);
  late Color onSecondaryContainer = const Color(0xFF081C15);
  late Color onAccent = const Color(0xFFFFFFFF);
  late Color accentContainer = const Color(0x1AF4A261);
  late Color onAccentContainer = const Color(0xFF081C15);
  late Color onBackground = const Color(0xFF081C15);
  late Color onSurface = const Color(0xFF081C15);
  late Color surfaceVariant = const Color(0xFFE9F5EF);
  late Color onSurfaceVariant = const Color(0xFF40916C);
  ...
  late Color surfaceVariant30 = const Color(0x4DE9F5EF);
  late Color primary40 = const Color(0x662D6A4F);
  late Color success15 = const Color(0x262D6A4F);
  late Color error15 = const Color(0x26E76F51);
  late Color onPrimary13 = const Color(0x21FFFFFF);
  late Color onBackground80 = const Color(0xCC081C15);
  late Color onWarning53 = const Color(0x87000000);
  late Color onWarning40 = const Color(0x66000000);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  late Color secondary = const Color(0xFF40916C);
  late Color tertiary = const Color(0xFFF4A261);
  late Color alternate = const Color(0xFF2D6A4F);
  late Color primaryText = const Color(0xFFD8F3DC);
  late Color secondaryText = const Color(0xFF95D5B2);
  late Color primaryBackground = const Color(0xFF081C15);
  late Color secondaryBackground = const Color(0xFF2D6A4F);
  late Color accent1 = const Color(0x4C4B39EF);
  late Color accent2 = const Color(0x4D39D2C0);
  late Color accent3 = const Color(0xFF52B788);
  ...
  late Color onPrimaryContainer = const Color(0xFFD8F3DC);
  late Color onSecondary = const Color(0xFFFFFFFF);
  late Color secondaryContainer = const Color(0x2440916C);
  late Color onSecondaryContainer = const Color(0xFFD8F3DC);
  late Color onAccent = const Color(0xFFFFFFFF);
  late Color accentContainer = const Color(0x24F4A261);
  late Color onAccentContainer = const Color(0xFFD8F3DC);
  late Color onBackground = const Color(0xFFD8F3DC);
  late Color onSurface = const Color(0xFFD8F3DC);
  late Color surfaceVariant = const Color(0xFF1B4332);
  late Color onSurfaceVariant = const Color(0xFF95D5B2);
  late Color onSuccess = const Color(0xFFFFFFFF);
  late Color onWarning = const Color(0xFF000000);
  late Color onError = const Color(0xFFFFFFFF);
  ...
  late Color onPrimary20 = const Color(0x33FFFFFF);
  late Color onPrimary80 = const Color(0xCCFFFFFF);
  late Color surfaceVariant30 = const Color(0x4D1B4332);
  late Color primary40 = const Color(0x6674C69D);
  late Color success15 = const Color(0x2674C69D);
  late Color error15 = const Color(0x26E76F51);
  late Color onPrimary13 = const Color(0x21FFFFFF);
  late Color onBackground80 = const Color(0xCCD8F3DC);
  late Color onWarning53 = const Color(0x87000000);
  late Color onWarning40 = const Color(0x66000000);
  late Color primary10 = const Color(0x1A74C69D);
  late Color success10 = const Color(0x1A74C69D);
}
...
class FFShadows {
  ...
  BoxShadow get xs => const BoxShadow(
      blurRadius: 2.0,
      color: const Color(0x0A081C15),
      offset: const Offset(0.0, 1.0),
      spreadRadius: 0.0);
  BoxShadow get sm => const BoxShadow(
      blurRadius: 4.0,
      color: const Color(0x0F081C15),
      offset: const Offset(0.0, 2.0),
      spreadRadius: 0.0);
  BoxShadow get md => const BoxShadow(
      blurRadius: 8.0,
      color: const Color(0x14081C15),
      offset: const Offset(0.0, 4.0),
      spreadRadius: 0.0);
  BoxShadow get lg => const BoxShadow(
      blurRadius: 16.0,
      color: const Color(0x1A081C15),
      offset: const Offset(0.0, 8.0),
      spreadRadius: 0.0);
  BoxShadow get xl => const BoxShadow(
      blurRadius: 24.0,
      color: const Color(0x1F081C15),
      offset: const Offset(0.0, 12.0),
      spreadRadius: 0.0);
  BoxShadow get xxl => const BoxShadow(
      blurRadius: 32.0,
      color: const Color(0x26081C15),
